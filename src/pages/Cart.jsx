...
function Cart() {
    ...
    const orderSubmit = () => {
        alert(`Your order is: ${totalCount} sushi, total amount: ${totalPrice}$`)
    }
                ...
                totalCount ?
                    <div className="cart">
                        ...
                        <div className="content__items">
                            {addedSushi.map(obj => <CartItem key={`${obj.name}_${obj.id}`}
                                                              id={obj.id}
                                                              name={obj.name}
                                                              type={obj.type}
                                                              size={obj.size}
                        ...
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                <span> Total Sushi: <b>{totalCount}</b> </span>
                            ...
                            <div className="cart__bottom-buttons">
                                ...
                                <Button onClick={orderSubmit} className="pay-btn">
                                    <span>Pay now</span>
                                </Button>
                            </div>
                        </div>
                    ...
                    <div className="cart cart--empty">
                        <h2>Cart is empty 😕</h2>
                        <p>
                            You probably haven't ordered sushi yet.<br/>
